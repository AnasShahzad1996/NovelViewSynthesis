...
class Config(ABC):
    ...
    def init(cls, path=None, only_known_args=False):
        ...
        p.add_argument('-ic', '--inputChannels', default=3, type=int, help="input channels")
        p.add_argument('-icv', '--inputChannelsViews', default=0, type=int, help="input channels views")
        p.add_argument('-mrv', '--multiResViews', default=0, type=int, help="multi res views")
        p.add_argument('-ie', '--iEmbed', default=0, type=int, help="iEmbed")
