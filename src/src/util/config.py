...
class Config(ABC):
    ...
    def init(cls, path=None, only_known_args=False):
        ...
        p.add_argument('-ic', '--inputChannels', default=[], type=int, action='append', help="input channels")
        p.add_argument('-icv', '--inputChannelsViews', default=[], type=int, action='append', help="input channels views")
        p.add_argument('-mrv', '--multiResViews', default=[], type=int, action='append', help="multi res views")
        p.add_argument('-ie', '--iEmbed', default=[], type=int, action='append', help="iEmbed")
