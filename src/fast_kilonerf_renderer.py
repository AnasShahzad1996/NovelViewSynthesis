    ...
    def render(self):
        ...
        while not is_final_pass:
            ...
            if compute_capability == (7, 5):
                network_eval_num_threads = 200 # for some reason the compiler uses more than 96 registers for this CC, so we cannot launch 640 threads
                print ("i think we are along now")
            else:
                network_eval_num_threads = 160 # it was 640 before
